...
//! bridge phases (list reconcile, panel/DataContext reconcile) are built on.
//!
...
//! does not matter. New, heavier reconcile phases should follow the pattern above
...
#[allow(dead_code)] // Scaffolding: consumed by the Phase 1/2 reconcile bridges.
...
mod tests {
    ...
    fn delta_pushes_drains_and_resets() {
        ...
        // `take` hands off the batch and resets for the next frame's diff.
